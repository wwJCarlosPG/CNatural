...
namespace CNaturalApi.Migrations
{
    ...
    [Migration("20220410233416_IsArrivedInvestedMigration")]
    partial class IsArrivedInvestedMigration
    {
            ...
            modelBuilder.Entity("CNaturalApi.Models.Accountancy", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Date = new DateTime(2022, 4, 10, 19, 34, 15, 914, DateTimeKind.Local).AddTicks(8455),
                            EarnedMoney = 0.0,
                            InvestedMoney = 0.0
                        });
                });
